...
"QA_24_CheckNewTask.jsp" + "?classneme=" + encodedCls + "&content=" + encodedCon
...
<html lang="ja">
    <head>
        ...
        <link
            rel="stylesheet"
            href="${page.Context.request.contextPath}/web_system/css/style_23_NewCreateTask.css"
        />
    </head>
    <body>
        <%--　ロゴに置き換える --%>
        ...
        <div class="view_list">
            ...
            <div class="info_box">
                <form action="" method="post">
                    ...
                    <br />
                    <input class="content_box" type="text" maxlength="50"
                    name="classneme" value="<%= (cls != null ? cls : "") %>"/>
                    <br /><br />
                    <label for="con">内容：</label>
                    <br />
                    <input class="content_box" type="text" maxlength="200"
                    name="content" value="<%= (con != null ? con : "") %>"/>
                    <br /><br />
                    <label for="lim">期限：</label>
                    <br />
                    <input class="content_box" type="text" maxlength="30"
                    name="limmit" value="<%= (lim != null ? lim : "") %>"/>
                    <br /><br />
                    <label for="out">提出場所：</label>
                    <br />
                    <input class="content_box" type="text" maxlength="100"
                    name="output" value="<%= (output != null ? output : "")
                    %>"/>
                    <br /><br />
                    <label for="detail">補足説明：</label><br />
                    <input class="textarea_box" type="text" maxlength="400"
                    name="detailcontent" value="<%= (detail != null ? detail :
                    "") %>"/>
                    <br /><br />
