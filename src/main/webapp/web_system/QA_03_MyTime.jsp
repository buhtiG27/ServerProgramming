...
<html lang="ja">
    ...
    <body>
        ...
        <div class="header_area">
            <form action="${pageContext.request.contextPath}/timetable/delete" method="get">
                <button class="delete_button" type="submit" name="delete" value="send">科目削除</button>
            </form>
            <h2>マイ時間割</h2>
            <form action="${pageContext.request.contextPath}/tasks" method="get">
                <button class="task_button" type="submit" name="alltask" value="send">課題一覧</button>
            </form>
        </div>
