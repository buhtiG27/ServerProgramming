...
<html lang="ja">
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/web_system/css/style_11_SearchQuestion.css">
	...
	<body>
		...
		<header>
			...
			<div class="filters">
    			<div class="searchbyKeyword">
        			<form action="${pageContext.request.contextPath}/questions/search" method="get" style="display:inline-flex;">
            			<input class="txt" type="text" name="searchbyKeyword" size="20" placeholder="質問を検索" value="${keyword}">
            			<button type="submit" style="background:none; border:none; cursor:pointer;">
                			<span class="fa-solid fa-magnifying-glass"></span>
            			</button>
        			</form>

        			<a href="${pageContext.request.contextPath}/questions" style="text-decoration: none;">
		...
		<main>
			...
			<%
    			...
    			String kwParam = (kw != null && !kw.isEmpty()) ? "&searchbyKeyword=" + java.net.URLEncoder.encode(kw, "UTF-8") : "";
			%>

    			<a href="${pageContext.request.contextPath}/questions/search?limit=<%= limit %>&offset=<%= prev %><%= kwParam %>">前へ</a>
    			<a href="${pageContext.request.contextPath}/questions/search?limit=<%= limit %>&offset=<%= next %><%= kwParam %>">次へ</a>
			</div>
