...
<div class="top_button">
	<h1>TDU</h1>
		<form action="Q&A_11_SearchQuestion.jsp" method="get">
			検索：
	...
	<div class="post-list">
		<div class="post">
		<form action="Q&A_10_ShowQuestion.jsp" method="get">
			<button class="show_button" type="submit" name="filterbyNew" value="send">投稿１</button>
		</form>
			<p>サンプル投稿を表示</p>
	...
	<br>
	<br>
	<form action="Q&A_12_CreateQuestion.jsp" method="get">
