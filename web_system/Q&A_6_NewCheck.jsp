...
<div class="request_list">
    ...
    <div class="bottom_buttons">
        ...
        <form class="form" action="Q&A_5_New.jsp" method="post">
        ...
        <form class="form" action="Q&A_1_Login.jsp" method="post">
            <input type="hidden" name="EmailAddress" value="<%= email %>">
            <input type="hidden" name="Password" value="<%= pw %>">
            <input type="hidden" name="Username" value="<%= user %>">
            <input type="hidden" name="GradeAndDepartment" value="<%= grade %>">
            <input type="hidden" name="Classification" value="<%= classification %>">
            <input type="hidden" name="message" value="登録が完了しました。ログインしてください。">
