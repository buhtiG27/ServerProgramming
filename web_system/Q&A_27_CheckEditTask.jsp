...
<link rel="stylesheet" href="css/style_27_CheckEditTask.css">
</head>
<body>
<%
...
<div class="request_list">
    ...
    <div class="bottom_buttons">
        ...
        <form class="form" action="Q&A_26_EditTask.jsp" method="post">
        ...
        <form class="form" action="Q&A_13_ViewTask.jsp" method="post">
            <input type="hidden" name="classname" value="<%= cls %>">
            <input type="hidden" name="content" value="<%= con %>">
            <input type="hidden" name="limmit" value="<%= lim %>">
            <input type="hidden" name="output" value="<%= output %>">
